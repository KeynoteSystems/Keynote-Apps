...
class Keynote_Client
{
    ...
    protected function _getData($request)
    {
        ...
        switch ($this->format) {
            case 'json':
                return json_decode($data);  // construct and return an array from the json string 
                break;
            case 'xml':
                return new SimpleXMLElement($data); // construct and return a SimpleXMLElement
                break;
        }
    }
     ...
     */
    public function getActiveSlotMetaData()
    {
    	/*
